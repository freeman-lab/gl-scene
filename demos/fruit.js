...
var shapes = [
  {
    ...
    position: [0, 0, 0],
    styles: {ambient: [0.4, 0.4, 0.4], diffuse: [0.3, 0.3, 0.3]}
  },
  {
    id: 'apple', class: 'sphere',
    complex: icosphere(4),
    position: [8, 0, 1],
    styles: {emissive: [0.8, 0.1, 0.0]}
  },
  {
    id: 'orange', class: 'sphere',
    complex: icosphere(4),
    position: [-5, -5, 2], scale: 2,
    styles: {emissive: [0.9, 0.6, 0.0]}
  },
  {
    id: 'pear', class: 'sphere',
    complex: icosphere(4),
    position: [0, 8, 3], scale: 3,
    styles: {emissive: [0.0, 0.9, 0.1]}
  }
]
...
var lights = [
  {
    id: 'point', 
    position: [0, 0, 5, 1],
    styles: {color: [1, 1, 1], intensity: 0.0, ambient: 0.0, attenuation: 0.01}
  }, 
  {
    id: 'pear-light', class: 'glow',
    position: [0, 8, 3, 1],
    styles: {color: [0.0, 0.9, 0.1]}
  },
  {
    id: 'apple-light', class: 'glow',
    position: [8, 0, 1, 1],
    styles: {color: [0.8, 0.1, 0.0]}
  },
  {
    id: 'orange-light', class: 'glow',
    position: [-5, -5, 2, 1],
    styles: {color: [0.9, 0.6, 0.0]}
  }
]
